...
# enter the capture and modify information (description, image, and Tag)
    scroll element into view         //div[contains(text(),'Barbecue')]
    click element                    //div[contains(text(),'Barbecue')]
...
# Click Icon close Window Filter
 ...
 # Enter Capture and modify Date
    scroll element into view         //div[contains(text(),'Chicken Fried')]
    click element                    //div[contains(text(),'Chicken Fried')]
